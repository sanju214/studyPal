    ...
    <>
        ...
        <nav class="w-32 z-3 bg-indigo-500 h-full opacity-20 pl-5" id="mySidebar"><br/>
          ...
          <div class=" flex flex-col space-between-4">
            <a href="#" onclick="w3_close()" class="pb-2 text-white">Chapter 1</a>
            <a href="" onclick="w3_close()" class="pb-2 text-white">Chapter 2</a>
            <a href="" onclick="w3_close()" class="pb-2 text-white">Chapter 3</a>
            <a href="" onclick="w3_close()" class="pb-2 text-white">Chapter 4</a>
            <a href="" onclick="w3_close()" class="pb-2 text-white">Chapter 5</a>
            <a href="" onclick="w3_close()" class="pb-2 text-white">Chapter 6</a>
          </div>
        </nav>
